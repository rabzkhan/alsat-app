...
class ProductDetailsView extends StatefulWidget {
  ...
  const ProductDetailsView(
      {super.key, this.productModel, this.isFromMessage = false});
                              ...
                              children: [
                                ...
                                infoTile(
                                    ...
                                    value: Get.find<LocalizationController>()
                                        .getTranslatedTransmission(widget
                                                .productModel
                                                ?.carInfo
                                                ?.transmission ??
                                            '')),
                                infoTile(
                                    ...
                                    value: Get.find<LocalizationController>()
                                        .getColorNameTranslated(widget
                                                .productModel?.carInfo?.color ??
                                            '')),
                                infoTile(
                                    name: localLanguage.vin_code,
                                    value:
                                        widget.productModel?.carInfo?.vinCode ??
                                            ''),
                              ],
                            )
                              ...
                              ? Column(
                                  ...
                                  children: [
                                    ...
                                    infoTile(
                                      ...
                                      value: Get.find<LocalizationController>()
                                          .getEstateTypeTranslated(widget
                                                  .productModel
                                                  ?.estateInfo
                                                  ?.type ??
                                              ''),
                                    ...
                                    infoTile(
                                      ...
                                      value: Get.find<LocalizationController>()
                                          .getEstateDealTypeTranslated(widget
                                                  .productModel
                                                  ?.estateInfo
                                                  ?.dealType ??
                                              ''),
                            ...
                            Row(
                              ...
                              children: [
                                Icon(
                                  Icons.check_circle,
                                  size: 14.r,
                                  color: (productDetailsController.postUserModel
                                ...
                                Text(
                                  ...
                                  style: (productDetailsController.postUserModel
                                              .value?.protectionLabel ??
                                          false)
                                      ? regular.copyWith(
                                          fontSize: 12.sp,
