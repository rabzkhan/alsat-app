...
class _PostProductViewState extends State<PostProductView> {
                        ...
                        onPressed: productController.isProductPosting.value
                            ...
                            : () {
                                ...
                                if (_formKey.currentState!.validate()) {
                                  ...
                                  if (productController.totalProductFiled.value !=
                                          productController.totalProductFiledCount.value ||
                                      productController.productPriceFiled.value !=
                                          productController.productPriceFiledCount.value ||
                                      productController.individualInfoFiled.value !=
                                          productController.individualInfoFiledCount.value) {
                                    CustomSnackBar.showCustomErrorToast(message: "Please fill all the fields");
                                  }
                                  if (productController.pickImageList.isEmpty) {
                                    CustomSnackBar.showCustomErrorToast(message: "Please select at least one image");
                                  } else {
  ...
  Future<void> addProductDataFormate(Map<String, dynamic> map) async {
    ...
    productPostMap['individual_info'] = {
      ...
      "location_geo": {
        "type": "Point",
        "coordinates": [productController.selectLatLon?.longitude ?? 0, productController.selectLatLon?.latitude ?? 0],
      },
