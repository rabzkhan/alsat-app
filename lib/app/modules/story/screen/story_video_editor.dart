...
class StoryVideoEditor extends StatefulWidget {
  ...
  const StoryVideoEditor(this.file, {super.key});
  @override
  State<StoryVideoEditor> createState() => _StoryVideoEditorState();
}
  ...
  _saveVideo() {
    ...
    _trimmer.saveTrimmedVideo(
      ...
      onSave: (outputPath) async {
        ...
        homeController.pickStoryVideoList = [];
        var mediaDataTemp = await videoToBase64(file.path);
        Map<String, dynamic> media = {"media": mediaDataTemp};
        homeController.postStory(media);
        Get.back();
      },
    );
  }
