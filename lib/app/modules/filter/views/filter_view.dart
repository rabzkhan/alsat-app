            ...
            child: Obx(
              () {
                return controller.category.value?.filter?.toLowerCase() == 'car'
                              ...
                              children: [
                                Expanded(
                                  child: Obx(() => FilterOptionWidget(
                                        ...
                                        onTap: () {
                                          RxList<String>
                                              translatedTransmissionTypeList =
                                              Get.find<LocalizationController>()
                                                  .getTranslatedTransmissionTypes(
                                                      controller.dTransmission)
                                                  .obs;
                                          Get.bottomSheet(
                                            FilterBottomSheet(
                                              title: localLanguage.transmission,
                    ...
                    : (controller.category.value?.filter
                                ?.toLowerCase()
                        ...
                        ? Container(
                            ...
                            child: Column(
                              children: [
                                if (controller.category.value?.filter !=
                                    "real_estate_2")
                                  //Estate Type
                                  Padding(
                                    padding: EdgeInsets.symmetric(
                                ...
                                if (controller.category.value?.filter !=
                                  ...
                                  Padding(
                                    ...
                                    child: FormBuilderDropdown<String>(
                                      ...
                                      onChanged: (newValue) {
                                        controller.dEstateRenovType.value =
                                            newValue!;
                                      },
                                      style: regular.copyWith(
                                        color: context.theme.primaryColor,
                                              ...
                                              Transform.scale(
                                                ...
                                                child: Obx(() {
                                                  return CupertinoSwitch(
                                                    value: controller
                                                        .isLiftAvaiable.value,
                                                    onChanged: (value) {
                                                      controller.isLiftAvaiable
                                                          .value = value;
                                                    },
                                                  );
                                                }),
          ...
          SliverToBoxAdapter(
            child: Padding(
              ...
              child: Column(
                children: [
                  Obx(() {
                    return controller.category.value?.filter?.toLowerCase() ==
                                'car' ||
                            controller.category.value?.filter?.toLowerCase() ==
                                'phone'
                        ? Row(
                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            children: [
