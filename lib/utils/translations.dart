...
final Map<String, Map<String, String>> colorTranslations = {
  ...
  "Gold": {"tr": "Altyn", "ru": "Золотой"},
  "Black": {"tr": "Gara", "ru": "Чёрный"},
  "Vinous": {"tr": "Gyzyl çalym", "ru": "Бордовый"},
  "Beige": {"tr": "Bež", "ru": "Бежевый"},
  "Bronze": {"tr": "Bronza", "ru": "Бронзовый"},
  "Blue": {"tr": "Gök", "ru": "Синий"},
  "Light Blue": {"tr": "Aç gök", "ru": "Голубой"},
  "Dark Blue": {"tr": "Gara gök", "ru": "Тёмно-синий"},
  "Yellow": {"tr": "Sary", "ru": "Жёлтый"},
  "Green": {"tr": "Ýaşyl", "ru": "Зелёный"},
  "Brown": {"tr": "Garagök", "ru": "Коричневый"},
  "Red": {"tr": "Gyzyl", "ru": "Красный"},
  "Metallic": {"tr": "Metalik", "ru": "Металлик"},
  "Wet Asphalt": {"tr": "Çygly asfalt", "ru": "Мокрый асфальт"},
  "Orange": {"tr": "Mämişi", "ru": "Оранжевый"},
  "Cherry": {"tr": "Wišnja", "ru": "Вишнёвый"},
  "Grey": {"tr": "Goňur", "ru": "Серый"},
};
