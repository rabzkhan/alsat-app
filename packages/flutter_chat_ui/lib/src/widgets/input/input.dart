...
class Input extends StatefulWidget {
  ...
  final void Function() emojiPicker;
...
class _InputState extends State<Input> {
  ...
  Widget _inputBuilder() {
    ...
    return Focus(
      ...
      child: Padding(
        padding: InheritedChatTheme.of(context).theme.inputMargin.copyWith(
              right:
                  InheritedChatTheme.of(context).theme.inputMargin.right * .5,
            ),
        child: Row(
          children: [
            Expanded(
                        ...
                        Row(
                          ...
                          children: [
                            AttachmentButton(
                              ...
                              imagePath: 'assets/attachment.png',
                            ),
                            SizedBox(
                              width: (buttonPadding.left * .2),
                            ),
                            AttachmentButton(
                              isLoading: widget.isAttachmentUploading ?? false,
                              onPressed: () {},
