...
void main() {
  final StoriesForFlutterPlatform initialPlatform =
      StoriesForFlutterPlatform.instance;
  ...
  test('getPlatformVersion', () async {
    ...
    MockStoriesForFlutterPlatform fakePlatform =
        MockStoriesForFlutterPlatform();
